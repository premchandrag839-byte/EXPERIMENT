...
export default function Intermediate2024Page() {
  const [active, setActive] = useState(null);
  const list = achievementsData[2024].intermediate;
  const router = useRouter();
  return (
    <div className="font-inter">
      <SEO title="Intermediate Board Exam Toppers (2023–2024)" description="Top 5 intermediate board exam toppers for 2023–2024." />
      <Section title="Intermediate Board Exam Toppers" subtitle="Batch 2023 – 2024">
